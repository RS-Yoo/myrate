...
const MyHealth = () => {
    ...
    const renderMuscleGroupSelector = () => {
        let muscles = ["Chest", "Abdominals", "Biceps", "Calves", "Forearms", "Glutes", "Hamstrings", "Lats",
                        "Lower Back", "Middle Back", "Quadriceps", "Traps", "Triceps"];
        return (
            <>
                <label id="muscleGroupLabel" for="muscleGroupDropdown">Select a muscle group:</label>
                <select id="muscleGroupDropdown" class="form-select form-select-sm" aria-label=".form-select-sm example" onChange={onSelectPickerChange}>
                {muscles.map(muscle => (
    ...
    const renderExerciseList = () => {
        return (
            <div id="exerciseContainer">
                {api_responses[muscleGroup].map(list => (
